let
  ...
  hosts =
    ...
    in
    {
      desktop-caroline = [ desktop-caroline ];
...
in
{
  "secrets/any/hashed-etu-password-file.age".publicKeys =
    etu
    ++ hosts.desktop-elis
  ...
  "secrets/laptop-private-caroline/hashed-concate-password-file.age".publicKeys =
    etu ++ hosts.laptop-private-caroline ++ hosts.desktop-caroline;
  "secrets/laptop-private-caroline/hashed-root-password-file.age".publicKeys =
    etu ++ hosts.laptop-private-caroline ++ hosts.desktop-caroline;
  "secrets/laptop-private-elis/etu_at_aarch64.nixos.community.age".publicKeys =
    etu ++ hosts.desktop-elis ++ hosts.laptop-private-elis;
  "secrets/laptop-private-elis/etu_at_aarch64.nixos.community.pub.age".publicKeys =
    etu ++ hosts.desktop-elis ++ hosts.laptop-private-elis;
  ...
  "secrets/server-main-elis/homepage-dashboard-environment.age".publicKeys =
    etu ++ hosts.server-main-elis;
