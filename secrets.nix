let
  ...
  # Computers host keys
  hosts = let
    inherit (keys.systems) desktop-caroline desktop-elis laptop-private-caroline laptop-private-elis laptop-work-elis server-main-elis server-sparv vps06;
  in {
...
in {
  ...
  "secrets/laptop-private-caroline/hashed-concate-password-file.age".publicKeys = etu ++ hosts.laptop-private-caroline ++ hosts.desktop-caroline;
  "secrets/laptop-private-caroline/hashed-root-password-file.age".publicKeys = etu ++ hosts.laptop-private-caroline ++ hosts.desktop-caroline;
