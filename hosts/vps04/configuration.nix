...

{
  ...
  users.users = {
    ...
    concate = {
      ...
      uid = 1001;
      openssh.authorizedKeys.keys = [
        "no-agent-forwarding,no-X11-forwarding,permitopen=\"localhost:8002\",command=\"echo 'This account can only be used for weechat relays'\" ssh-rsa  irc@android-2019-02-20"
