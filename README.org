[[https://github.com/etu/nixconfig/actions/workflows/cachix.yml][https://github.com/etu/nixconfig/actions/workflows/cachix.yml/badge.svg]]
...
**** ~hosts/home-server/~
Home file server, deployed using ~deploy .#fenchurch~. Also used as build
...
from this system to fenchurch. Deployed using ~deploy .#vps04~.
